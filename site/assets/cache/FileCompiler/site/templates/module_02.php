...
$query_uri = 'http://informea.pops.int/mfilesInformea/MFilesMea.svc/Documents?$top=20&$filter=titles/any(x:%20x/language%20eq%20%27en%27)%20and%20files/any(x:%20x/brsExtension%20eq%20%27pdf%27)%20and%20titles/any(x:%20substringof(%27life%20cycle%27,%20x/value)%20eq%20true)&$select=updated,authors,authors/value,files,files/url,files/language,tags,tags/value,types,types/value,titles,titles/value&$expand=authors,files,tags,types,titles';
$build_entries = new CWPlatform\InformeaData\BuildEntryData("module_2", $query_uri);
...
<div class="parallax-window" data-parallax="scroll" data-image-src="<?php echo $config->urls->assets ?>images/banner-02.jpg" 
        style="height: 150px; display: flex; align-items: flex-end; color: #fff;">
        
    <div class="container">
        <div class="row">
            <div class="col-md-12" style="text-shadow: 3px 3px 3px #1d3549">
                <span style="font-size: 60px;">Module 2</span>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12">
            <p class="text-center iframeWrapper">
                <iframe src="/learning_modules/module-02/story_html5.html" frameBorder="0"></iframe>
            </p>
        </div>
    </div>
